                            ...
                            <div class="tv-elements">
                                @foreach ($category['tvs'] as $tv)
                                    <div class="element-icon tv-element" draggable="true" data-type="tv"
                                        data-tv-id="{{ $tv['id'] }}" data-tv-name="{{ $tv['name'] }}"
        ...
        <div class="split-view">
            ...
            <div class="split-panel">
                <div class="panel-header">
                    ...
                    <button id="clear-workspace" class="btn btn-sm btn-outline-danger ms-auto"
                            ...
                            @foreach ($repositories as $index => $repo)
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link {{ $index === 0 ? 'active' : '' }}"
                                        id="repo-{{ $repo['id'] }}-tab" data-bs-toggle="tab"
                                        data-bs-target="#repo-{{ $repo['id'] }}" type="button" role="tab">
                        ...
                        <div class="tab-content" id="libraryTabsContent">
                            @foreach ($repositories as $index => $repo)
                                <div class="tab-pane fade {{ $index === 0 ? 'show active' : '' }}"
                                    id="repo-{{ $repo['id'] }}" role="tabpanel" data-repo-url="{{ $repo['url'] }}">
